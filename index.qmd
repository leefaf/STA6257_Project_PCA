...
It provides several graphs and figures. Lever, J., Krzywinski, M., &
Altman, N. (2017, July). Principal component analysis. Nature Methods,
14(7), 641-642. Retrieved from Academic
OneGile.]{style="color: #8B814C;"}
...
when to use PCA and how to interpret the results. Camargo A. 2022.
PCAtest: testing the statistical significance of Principal Component
Analysis in R. PeerJ 10:e12967 DOI
10.7717/peerj.12967]{style="color: #8B814C;"}
...
advantages and disadvantages of using the method. Journal of Signal and
Information Processing, 2013, 4, 173-175 doi:10.4236/jsip.2013.43B031
Published Online August 2013
(http://www.scirp.org/journal/jsip)]{style="color: #8B814C;"}
...
results from PCA is given as a general model. Exploration of Principal
Component Analysis: Deriving Principal Component Analysis Visually Using
Spectra. (2020, December 21). Applied Spectroscopy, 75(4), 361-375.
doi:10.1177/0003702820987847]{style="color: #8B814C;"}
...
included. Jolliffe IT, Cadima J. 2016 Principal component analysis: a
review and recent developments.Phil. Trans. R. Soc. A 374: 20150202.
http://dx.doi.org/10.1098/rsta.2015.0202]{style="color: #8B814C;"}
